/**
 * Helpers for handling minor-unit amounts as text. USDC on Stellar has 7 decimals,
 * so 1.00 USDC is "10000000" and 20.00 USDC is "200000000". We store and serialize as
...
/**
 * Formats a minor-unit string using the asset's decimals. Default 7 (USDC on Stellar).
