...
const envSchema = z.object({
  ...
  DRIZZLE_DATABASE_URL: z.string().url().default('postgres://demo:demo@localhost:5432/padalacalendar'),
  ...
  SESSION_SECRET: z
    ...
    .default('padalacalendar-demo-session-secret-at-least-32-chars'),
  ...
  /** Public source account used to identify bridge payment intents. Signing remains external. */
  HUB_STELLAR_PUBLIC_KEY: z.string().optional(),
